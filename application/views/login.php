			...
			<div class="row justify-content-center">
				...
				<div class="col-xl-5 col-lg-12 col-md-9">
					...
					<div class="card o-hidden border-0 shadow-lg my-5">
						<!-- <img class="card-img-top" src="<?=base_url();?>assets/img/maxresdefault.jpg" height="149px" alt="Card image"> -->
								...
								<div class="col-lg-12">
									<div class="p-4">
										...
										<div class="text-center mb-4">
											<img src="<?php echo base_url("assets/img/ASTRA.png") ?>" width="190px" class="rounded" >
										</div>
