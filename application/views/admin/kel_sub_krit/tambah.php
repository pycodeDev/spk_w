                    ...
                    <div id="content">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="container-fluid">
                                        <form action="<?=base_url()?>admin/test_sub_krit" method="post">
                                        <div class="form-group row">
                                            <div class="col-sm-10">
                                            <input type="hidden" name="id_kriteria" value="<?=$id_kriteria?>" >
                                                <input type="text" class="form-control" value="<?=$krit->nama_kriteria?>" readonly>
                                            </div>
                                        </div>
                                            <div class="form-group" id="dynamic_form">
                                                <div class="row">
                                                    <div class="col-md-5">
                                                        <input type="text" name="sub_kriteria" id="p_name" placeholder="Masukkan Sub Kriteria" class="form-control">
                                                    </div>
                                                    <div class="col-md-5">
