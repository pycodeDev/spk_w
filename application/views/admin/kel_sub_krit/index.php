                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <h6 class="m-1 font-weight-bold text-success float left">Kelola Sub Kriteria</h6>
                                        </div>
                                        <div class="col-md-6">
    ...
    function get_data(id){
        $.ajax({
            ...
            success: function(data){
                    ...
                    var a = '<a class="btn btn-sm btn-danger my-2" href="<?=base_url()?>admin/del_sub_krit/' + id + '"><i class="fas fa-trash-alt"></i> Hapus</a>';
                    $('#btn').html(a);
                    $("#btn").show();
                    $("#btn_tambah").hide();
                    console.log(id_krit)
                    }else{
                        var b = '<a href="<?=base_url()?>admin/tambah_sub_kriteria/'+ id +'" class="float-right btn btn-sm btn-success" style="color:#fff;"><i class="fas fa-plus"></i> Tambah Data</a>';
