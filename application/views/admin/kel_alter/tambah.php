                        ...
                        <div class="container-fluid">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <h6 class="m-1 font-weight-bold text-success float left">Tambah Kriteria</h6>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    ...
                                    <form action="<?=base_url()?>admin/tambah_alternatif" method="post">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                            <input type="text" placeholder="Nama Alternatif" name="nama_alternatif" class="form-control" id="nama_alternatif">
